...
<template>
    <JetFormSection @submitted="updatePassword" :split="true">
        <template #title>
            Actualizar contraseña
        </template>

        <template #description>
            Asegura tu cuenta utilizando una contraseña larga y aleatoria.
        </template>
        ...
        <template #actions>
            ...
            <JetButton type="submit" :class="{ 'opacity-25': form.processing }" :disabled="form.processing">
                Guardar
            </JetButton>
        </template>
    </JetFormSection>
